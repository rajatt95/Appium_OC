...
public class __23_Waits_02_Explicit {

	@Test
	public void TC__23_Waits_Implicit() throws MalformedURLException, InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(views)).click();
