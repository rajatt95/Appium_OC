...
public class __34_GestureSwipe {

	@Test
	public void TC__34_GestureSwipe() throws MalformedURLException, InterruptedException {
...
//		Thread.sleep(3000);
	...
	private void scroll3TimesLecture(AppiumDriver driver) {
		...
		// press(PointOption.point(477, 1891)).
				...
				waitAction(WaitOptions.waitOptions(Duration.ofMillis(2000))).moveTo(PointOption.point(494, 386))
				.release().perform();
